    ...
    $.Slitslider.prototype = {
        ...
        _navigate : function( dir, pos ) {
            ...
            var transitionProp = {
                ...
                '-webkit-transition' : 'all ' + this.options.speed + 'ms ease-in-out',
                '-moz-transition' : 'all ' + this.options.speed + 'ms ease-in-out',
                '-o-transition' : 'all ' + this.options.speed + 'ms ease-in-out'
            };
